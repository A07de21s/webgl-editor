Sidebar.Geometry.TorusGeometry = function(editor, object) 
{
  ...
  tubeRow.add(new UI.Text('管道').setWidth('90px'));
  tubeRow.add(tube);
  ...
  var radialSegments =
    new UI.Integer(parameters.radialSegments).setRange(1, Infinity).onChange(update);

  radialSegmentsRow.add(new UI.Text('径向分段数').setWidth('90px'));
  ...
  var tubularSegments =
    new UI.Integer(parameters.tubularSegments).setRange(1, Infinity).onChange(update);

  tubularSegmentsRow.add(new UI.Text('管道分段数').setWidth('90px'));
  ...
  arcRow.add(new UI.Text('弧度').setWidth('90px'));
  arcRow.add(arc);
