Sidebar.Object = function(editor) 
{
  ...
  var objectActions = 
    new UI.Select().setPosition('absolute').setRight('8px').setFontSize('11px');
  ...
  {
    editor.execute(new SetValueCommand(editor.selected, 'name', 
                   objectName.getValue()));
  });
  ...
  var objectRotationX = 
    new UI.Number().setStep(10).setUnit('°').setWidth('50px').onChange(update);
  var objectRotationY = 
    new UI.Number().setStep(10).setUnit('°').setWidth('50px').onChange(update);
  var objectRotationZ = 
    new UI.Number().setStep(10).setUnit('°').setWidth('50px').onChange(update);

  objectRotationRow.add(new UI.Text('旋转角度').setWidth('90px'));
  ...
  var objectScaleLock =
    new UI.Checkbox(true).setPosition('absolute').setLeft('75px');
  var objectScaleX = 
    new UI.Number(1).setRange(0.01, Infinity).setWidth('50px').onChange(updateScaleX);
  var objectScaleY = 
    new UI.Number(1).setRange(0.01, Infinity).setWidth('50px').onChange(updateScaleY);
  var objectScaleZ = 
  ...
  objectNearRow.add(new UI.Text('近景').setWidth('90px'));
  ...
  objectFarRow.add(new UI.Text('远景').setWidth('90px'));
  ...
  objectIntensityRow.add(new UI.Text('亮度').setWidth('90px'));
  ...
  objectGroundColorRow.add(new UI.Text('网格颜色').setWidth('90px'));
  ...
  var objectAngle = 
    new UI.Number().setPrecision(3).setRange(0, Math.PI / 2).onChange(update);
  ...
  var objectReceiveShadow = 
    new UI.THREE.Boolean(false, 'receive').onChange(update);
  ...
  objectVisibleRow.add(new UI.Text('显示').setWidth('90px'));
  ...
  var objectUserData = 
    new UI.TextArea().setWidth('150px').setHeight('40px').setFontSize('12px').onChange(update);
  ...
  objectUserDataRow.add(new UI.Text('扩展数据').setWidth('90px'));
