Sidebar.Material = function(editor) 
{
  ...
  managerRow.add(new UI.Button('新建').onClick(function() 
  {
    ...
    editor.execute(new SetMaterialCommand(currentObject, material), 
                                          'New Material: ' + 
  ...
  managerRow.add(new UI.Button('复制').onClick(function() 
  {
    copiedMaterial = currentObject.material;
  }));

  managerRow.add(new UI.Button('粘贴').onClick(function() 
  {
    if (copiedMaterial === undefined) return;
    editor.execute(new SetMaterialCommand(currentObject, copiedMaterial), 
                   'Pasted Material: ' + materialClass.getValue());
    refreshUI();
    update();
  }));
  ...
  var materialUUID = 
    new UI.Input().setWidth('115px').setFontSize('12px').setDisabled(true);
  var materialUUIDRenew = 
    new UI.Button('⟳').setMarginLeft('7px').onClick(function() 
  {
  ...
  var materialName = 
    new UI.Input().setWidth('150px').setFontSize('12px').onChange(function() 
  {
    editor.execute(new SetMaterialValueCommand(editor.selected, 'name', 
  ...
  var materialRoughness = 
    new UI.Number(0.5).setWidth('60px').setRange(0, 1).onChange(update);
  ...
  var materialMetalness = 
    new UI.Number(0.5).setWidth('60px').setRange(0, 1).onChange(update);

  materialMetalnessRow.add(new UI.Text('金属性').setWidth('90px'));
  ...
  materialEmissiveRow.add(new UI.Text('放射').setWidth('90px'));
  ...
  materialShininessRow.add(new UI.Text('光泽').setWidth('90px'));
  ...
  var materialDisplacementScale = 
    new UI.Number(1).setWidth('30px').onChange(update);
  ...
  var materialEnvMap = 
    new UI.Texture(THREE.SphericalReflectionMapping).onChange(update);
  ...
  var materialAOScale = 
    new UI.Number(1).setRange(0, 1).setWidth('30px').onChange(update);
  ...
  materialSideRow.add(new UI.Text('侧面穿透').setWidth('90px'));
  ...
  materialShadingRow.add(new UI.Text('底纹').setWidth('90px'));
  ...
  var materialOpacity = 
    new UI.Number(1).setWidth('60px').setRange(0, 1).onChange(update);
  ...
  var materialAlphaTest = 
    new UI.Number().setWidth('60px').setRange(0, 1).onChange(update);
  ...
  var materialWireframeLinewidth = 
    new UI.Number(1).setWidth('60px').setRange(0, 100).onChange(update);

  materialWireframeRow.add(new UI.Text('框架骨骼').setWidth('90px'));
  ...
  function update()
  {
    ...
    if (material) 
    {
      ...
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'uuid',
      ...
      {
        editor.execute(new SetMaterialColorCommand(currentObject, 'color', 
                       materialColor.getHexValue()));
      }

      if (material.roughness !== undefined && 
          Math.abs(material.roughness - materialRoughness.getValue()) >= 0.01) 
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'roughness', 
                       materialRoughness.getValue()));
      }

      if (material.metalness !== undefined && 
          Math.abs(material.metalness - materialMetalness.getValue()) >= 0.01) 
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'metalness', 
      ...
      {
        editor.execute(new SetMaterialColorCommand(currentObject, 'emissive', 
      ...
      {
        editor.execute(new SetMaterialColorCommand(currentObject, 'specular', 
                       materialSpecular.getHexValue()));
      }

      if (material.shininess !== undefined && 
          Math.abs(material.shininess - materialShininess.getValue()) >= 0.01) 
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'shininess', 
      ...
      if (material.vertexColors !== undefined) 
      {
        ...
        {
          editor.execute(new SetMaterialValueCommand(currentObject, 
      ...
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'skinning', 
      ...
      if (material.alphaMap !== undefined) 
      {
        ...
        if (objectHasUvs) 
        {
          ...
          {
            editor.execute(new SetMaterialMapCommand(currentObject, 
                                                     'alphaMap', alphaMap));
          }
        } 
        else
      ...
      if (material.bumpMap !== undefined) 
      {
        ...
        if (objectHasUvs) 
        {
          ...
          {
            editor.execute(new SetMaterialMapCommand(currentObject, 'bumpMap',
                           bumpMap));
          }
          ...
          {
            editor.execute(new SetMaterialValueCommand(currentObject, 
                           'bumpScale', materialBumpScale.getValue()));
          }
        } 
        else 
        {
      ...
      if (material.normalMap !== undefined) 
      {
        ...
        if (objectHasUvs) 
        {
          ...
          {
            editor.execute(new SetMaterialMapCommand(currentObject, 'normalMap',
                           normalMap));
          }
        } 
        else
      ...
      if (material.displacementMap !== undefined) 
      {
        ...
        {
          var displacementMap = 
            displacementMapEnabled ? materialDisplacementMap.getValue() : null;
      ...
      if (material.roughnessMap !== undefined) 
      {
        ...
        {
          var roughnessMap = 
            roughnessMapEnabled ? materialRoughnessMap.getValue() : null;
      ...
      if (material.metalnessMap !== undefined) 
      {
        ...
        {
          var metalnessMap =
            metalnessMapEnabled ? materialMetalnessMap.getValue() : null;
      ...
      if (material.specularMap !== undefined) 
      {
        ...
        {
          var specularMap = 
            specularMapEnabled ? materialSpecularMap.getValue() : null;
      ...
      if (material.aoMap !== undefined) 
      {
        ...
        if (objectHasUvs) 
        {
          ...
          {
            editor.execute(new SetMaterialMapCommand(currentObject, 'aoMap', 
                                                     aoMap));
          }
          ...
          {
            editor.execute(new SetMaterialValueCommand(currentObject, 
                           'aoMapIntensity', materialAOScale.getValue()));
          }
        } 
        else 
        {
      ...
      if (material.emissiveMap !== undefined) 
      {
        ...
        {
          var emissiveMap = 
            emissiveMapEnabled ? materialEmissiveMap.getValue() : null;
      ...
      if (material.side !== undefined) 
      {
        ...
        {
          editor.execute(new SetMaterialValueCommand(currentObject, 'side',
                                                     side));
        }
      }
      ...
      if (material.shading !== undefined) 
      {
        ...
        {
          editor.execute(new SetMaterialValueCommand(currentObject, 'shading', 
                                                     shading));
        }
      }
      ...
      if (material.blending !== undefined) 
      {
        ...
        {
          editor.execute(new SetMaterialValueCommand(currentObject, 'blending', 
                                                     blending));
        }
      }

      if (material.opacity !== undefined && 
          Math.abs(material.opacity - materialOpacity.getValue()) >= 0.01) 
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'opacity', 
      ...
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'transparent', 
                       materialTransparent.getValue()));
      }

      if (material.alphaTest !== undefined && 
          Math.abs(material.alphaTest - materialAlphaTest.getValue()) >= 0.01) 
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'alphaTest', 
      ...
      {
        editor.execute(new SetMaterialValueCommand(currentObject, 'wireframe', 
                       materialWireframe.getValue()));
      }

      if (material.wireframeLinewidth !== undefined &&
          Math.abs(material.wireframeLinewidth - 
            materialWireframeLinewidth.getValue()) >= 0.01) 
      {

        editor.execute(new SetMaterialValueCommand(currentObject, 
                       'wireframeLinewidth', 
                       materialWireframeLinewidth.getValue()));
      }
      refreshUI();
    }
