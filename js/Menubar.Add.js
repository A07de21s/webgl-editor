Menubar.Add = function(editor) 
{
  ...
  option.onClick(function() 
  {
    ...
    var geometry = new THREE.CylinderBufferGeometry(radiusTop, radiusBottom, 
  ...
  option.onClick(function() 
  {
    ...
    var geometry = new THREE.SphereBufferGeometry(radius, widthSegments, 
                                                  heightSegments, phiStart, 
...
*/
  ...
  option.onClick(function() 
  {
    ...
    var geometry = new THREE.TorusBufferGeometry(radius, tube, radialSegments, 
                                                 tubularSegments, arc);
    var mesh = new THREE.Mesh(geometry, new THREE.MeshStandardMaterial());
  ...
  option.onClick(function() 
  {
    ...
    var geometry = new THREE.TorusKnotBufferGeometry(radius, tube, 
                                                     tubularSegments, 
                                                     radialSegments, p, q);
    var mesh = new THREE.Mesh(geometry, new THREE.MeshStandardMaterial());
  ...
  option.onClick( function () {
  	...
  	var geometry = new THREE.TeapotBufferGeometry(size, segments, bottom, lid,
                                                  body, fitLid, blinnScale);
  	var mesh = new THREE.Mesh( geometry, material );
  ...
  */
  ...
  option.onClick(function() 
  {
    ...
    var geometry = new THREE.LatheBufferGeometry(points, segments, phiStart,
                                                 phiLength);
    var mesh = new THREE.Mesh(geometry, new THREE.MeshStandardMaterial({ 
