...
/*
  ...
  options.innerHTML = 'Points \
          ...
          <label for="uniform">Uniform Catmull-rom</label>  \
          <input type="range" id="tension" \
           onchange="splines.uniform.tension = \
            tension.value;updateSplineOutline();" \
           min=0 max=1 step=0.01 value=0.5 /> <span id="tension_value" />\
          </span> <br />\
          <input type="checkbox" id="centripetal" checked /> \
           Centripetal Catmull-rom<br />\
          <input type="checkbox" id="chordal" checked /> \
          Chordal Catmull-rom<br />';
  ...
  var dragcontrols = new THREE.DragControls(camera, splineHelperObjects, 
                                            renderer.domElement); //
  ...
  load([new THREE.Vector3(289.76843686945404, 452.51481137238443, 
                          56.10018915737797),
    new THREE.Vector3(-53.56300074753207, 171.49711742836848, 
                      -14.495472686253045),
    new THREE.Vector3(-91.40118730204415, 176.4306956436485, 
                      -6.958271935582161),
    new THREE.Vector3(-383.785318791128, 491.1365363371675, 
                      47.869296953772746)
  ]);
