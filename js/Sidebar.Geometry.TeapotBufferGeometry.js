Sidebar.Geometry.TeapotBufferGeometry = function(signals, object) 
{
  ...
  var segments = 
    new UI.Integer(parameters.segments).setRange(1, Infinity).onChange(update);

  segmentsRow.add(new UI.Text('分段数').setWidth('90px'));
  ...
  lidRow.add(new UI.Text('盖子').setWidth('90px'));
  lidRow.add(lid);
  ...
  bodyRow.add(new UI.Text('本体').setWidth('90px'));
  bodyRow.add(body);
