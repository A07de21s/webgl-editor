var Viewport = function(editor) 
{
    ...
    if (object !== undefined) 
    {
      switch (transformControls.getMode()) 
      {
        case 'translate':
          ...
          {
            editor.execute(new SetPositionCommand(object, object.position,
        ...
        case 'rotate':
          ...
          {
            editor.execute(new SetRotationCommand(object, object.rotation, 
        ...
        case 'scale':
          ...
          {
            editor.execute(new SetScaleCommand(object, object.scale, 
                  objectScaleOnDown));
          }
          break;
      }
  ...
  signals.sceneFogChanged.add(function(fogType, fogColor, fogNear, fogFar, 
                                       fogDensity) 
  {
